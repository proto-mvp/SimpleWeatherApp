...
@Composable
fun WeatherResultsScreen(state: WeatherInformationState, sendAction: (String) -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
//            )
        ...
        when (state) {
            ...
            is WeatherInformationState.ScreenInfo -> WeatherCard(information = state.presentationModel.cityWeatherInformation)
        }
    }
}